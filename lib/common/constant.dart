...
const appName = 'FlClash-EE';
const appHelperService = 'FlClashEEHelperService';
const coreName = 'clash.meta';
const browserUa =
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
const packageName = 'com.follow.clash.ee';
final unixSocketPath = '/tmp/FlClashEESocket_${Random().nextInt(10000)}.sock';
...
const repository = 'zxc135781/FlClash';
...
final mainIsolate = 'FlClashEEMainIsolate';

final serviceIsolate = 'FlClashEEServiceIsolate';
